...
```{r, echo=FALSE}
setwd("/home/gaozheng/Teaching/Stats406/R_scripts/lab2/")
```

## Review

A brief recap of what we covered in class.
...
### While loops
Like in any language, be careful with terminating condition(s). Avoid infinite loops.
...
### Quiz: How to parallelize the code (as much as possible)?
