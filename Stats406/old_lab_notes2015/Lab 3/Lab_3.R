...
for(i in 1:length(samplesizevector)){
  SampleMeans_unif[, i] = sqrt(samplesizevector[i])*sqrt(12)*apply(BigRVMatrix_unif[, 1:samplesizevector[i]], 1, mean);
}
...
for(i in 1:length(samplesizevector)){
  SampleMeans_normal[, i] = sqrt(samplesizevector[i])*apply(BigRVMatrix_normal[, 1:samplesizevector[i]], 1, mean);
}
...
# page 1
par(mfrow=c(2, 2));
hist(SampleMeans_unif[, 1], xlim=c(-5, 5));
hist(SampleMeans_unif[, 2], xlim=c(-5, 5));
hist(SampleMeans_normal[, 1], xlim=c(-5, 5));
hist(SampleMeans_normal[, 2], xlim=c(-5, 5));
# page 2
par(mfrow=c(2, 2));
hist(SampleMeans_unif[, 3], xlim=c(-5, 5));
hist(SampleMeans_unif[, 4], xlim=c(-5, 5));
hist(SampleMeans_normal[, 3], xlim=c(-5, 5));
hist(SampleMeans_normal[, 4], xlim=c(-5, 5));
dev.off();
